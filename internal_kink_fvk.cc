...
int main()
{
  ...
  FoepplVonKarmanC1CurvableBellElement<2> right_el_straight;
  FoepplVonKarmanC1CurvableBellElement<2> left_el_straight;
  FoepplVonKarmanC1CurvableBellElement<2> right_el_cubic;
  FoepplVonKarmanC1CurvableBellElement<2> left_el_cubic;
  FoepplVonKarmanC1CurvableBellElement<2> right_el_quintic;
  FoepplVonKarmanC1CurvableBellElement<2> left_el_quintic;
  // Array of element pointers
  // (named for what it is Matthias, not what it contains)
  FoepplVonKarmanC1CurvableBellElement<2>* right_el_pt_array[3] =
    {&right_el_straight, &right_el_cubic, &right_el_quintic};
  FoepplVonKarmanC1CurvableBellElement<2>* left_el_pt_array[3] =
    {&left_el_straight, &left_el_cubic, &left_el_quintic};
  for(unsigned i = 0; i < 3; i++)
  {
    FoepplVonKarmanC1CurvableBellElement<2>* right_el_pt = right_el_pt_array[i];
    FoepplVonKarmanC1CurvableBellElement<2>* left_el_pt = left_el_pt_array[i];
  ...
  {
      FoepplVonKarmanC1CurvableBellElement<2>* right_el_pt = right_el_pt_array[i_el];
      FoepplVonKarmanC1CurvableBellElement<2>* left_el_pt = left_el_pt_array[i_el];
      ...
      for (unsigned i = 0; i < n_node; i++)
      {
          for (unsigned j = 0; j < n_nodal_type; j++)
          {
              ...
              right_el_pt->full_output(outfile, 100);
              left_el_pt->full_output(outfile, 100);
