...
void UnstructuredFvKProblem<ELEMENT>::doc_solution(const std::string& comment)
{
  ...
  // u_0 =
  //   dynamic_cast<ELEMENT*>(geom_obj_pt)->interpolated_fvk_disp(s);
...
int main(int argc, char** argv)
{
  ...
  std::cout << "Mesh pointer = " << mesh_pt << std::endl;
  ...
  for(unsigned i=0; i<3; i++)
  {
    ...
    {
      mesh_pt->node_pt(i)->set_value(2+j,1.0);
