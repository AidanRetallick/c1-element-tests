...
int main()
{
  ...
  KoiterSteigmannC1CurvableBellElement el_straight;
  KoiterSteigmannC1CurvableBellElement el_cubic;
  KoiterSteigmannC1CurvableBellElement el_quintic;
  // Array of element pointers
  // (named for what it is Matthias, not what it contains)
  KoiterSteigmannC1CurvableBellElement* el_pt_array[3] =
  ...
  {
    KoiterSteigmannC1CurvableBellElement* el_pt = el_pt_array[i_el];
